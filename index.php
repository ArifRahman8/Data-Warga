...
if(isset($_POST['simpan'])){
    ...
    //print_r($_POST);
    if($querysimpan==TRUE){
        $pesansimpan="Berhasi Tersimpan Ke Database";
    }else{
        $pesansimpan="Gagal Tersimpan Ke Database";
    }
}
if(isset($_GET['hapus'])){
...
<div class="container">
    ...
    <div class="py-3">
    <h2>Data Warga</h2>
        <a href="daftar.php" class='btn btn-success'>Tambah Data</a>
    </div>
    <?php 
    if(isset($_POST['simpan'])){
       ?>
...
<?php 
    ...
    foreach($data_warga as $data){ 
        ...
        <tr>
            ...
            <td><a class="badge badge-primary" href="detail.php?id=<?php echo $data['id']; ?>">detail</a> <a class="badge badge-danger" href="index.php?hapus=<?php echo $data['id']; ?>">Hapus</a></td>
        </tr>
    <?php } ?>
    </table>
    </div>
