...
<body>
    ...
    <div class="row">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td>Nama</td>
                <td><input class="form-group" type="text" name="nama" id="nama"></td>
            </tr>
            <tr>
                <td>Alamat</td>
                <td> <input class="form-group" type="text" name="alamat" id="alamat"></td>
            </tr>
            <tr>
                <td>Nomor HP</td>
            ...
            <tr>
                <td colspan="2"> <button class="btn btn-success" name="simpan" type="submit">Simpan</button></td>
